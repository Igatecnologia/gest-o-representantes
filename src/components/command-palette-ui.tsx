...
const CREATE_ALL = [
  ...
  { label: "Novo negócio", href: "/pipeline/novo", icon: Plus, adminOnly: false },
...
/**
 * UI pesada do command palette (carrega cmdk lib).
 * Importada via next/dynamic só quando o user abre — não está no bundle inicial.
 */
